...
class CerveceriumController extends BaseController
{
    public function index(Request $request)
    {
        ...
        $cervecerias = Cervecerium::distinct()
                                    ...
                                    ->when($provincia_id, function ($query, $provincia_id) {$query->where('cerveceria.provincia_id', $provincia_id);})
                                    ->when($localidad_id, function ($query, $localidad_id) {$query->where('cerveceria.localidad_id', $localidad_id);})
