...
class FillPermissionsForProvincium extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProvincium constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.provincium',
            'admin.provincium.index',
            'admin.provincium.create',
            'admin.provincium.show',
            'admin.provincium.edit',
            'admin.provincium.delete',
            'admin.provincium.bulk-delete',
        ]);
