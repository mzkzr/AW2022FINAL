...
class FillPermissionsForPuntoVentum extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPuntoVentum constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.punto-ventum',
            'admin.punto-ventum.index',
            'admin.punto-ventum.create',
            'admin.punto-ventum.show',
            'admin.punto-ventum.edit',
            'admin.punto-ventum.delete',
            'admin.punto-ventum.bulk-delete',
        ]);
