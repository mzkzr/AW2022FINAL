...
class FillPermissionsForCerveza extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCerveza constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cerveza',
            'admin.cerveza.index',
            'admin.cerveza.create',
            'admin.cerveza.show',
            'admin.cerveza.edit',
            'admin.cerveza.delete',
            'admin.cerveza.bulk-delete',
        ]);
