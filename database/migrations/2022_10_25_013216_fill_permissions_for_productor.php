...
class FillPermissionsForProductor extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProductor constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.productor',
            'admin.productor.index',
            'admin.productor.create',
            'admin.productor.show',
            'admin.productor.edit',
            'admin.productor.delete',
            'admin.productor.bulk-delete',
        ]);
