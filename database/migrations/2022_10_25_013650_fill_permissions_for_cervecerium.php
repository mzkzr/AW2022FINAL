...
class FillPermissionsForCervecerium extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCervecerium constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cervecerium',
            'admin.cervecerium.index',
            'admin.cervecerium.create',
            'admin.cervecerium.show',
            'admin.cervecerium.edit',
            'admin.cervecerium.delete',
            'admin.cervecerium.bulk-delete',
        ]);
