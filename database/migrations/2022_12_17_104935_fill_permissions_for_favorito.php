...
class FillPermissionsForFavorito extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFavorito constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.favorito',
            'admin.favorito.index',
            'admin.favorito.create',
            'admin.favorito.show',
            'admin.favorito.edit',
            'admin.favorito.delete',
            'admin.favorito.bulk-delete',
        ]);
