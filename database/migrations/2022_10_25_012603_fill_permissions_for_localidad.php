...
class FillPermissionsForLocalidad extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLocalidad constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.localidad',
            'admin.localidad.index',
            'admin.localidad.create',
            'admin.localidad.show',
            'admin.localidad.edit',
            'admin.localidad.delete',
            'admin.localidad.bulk-delete',
        ]);
